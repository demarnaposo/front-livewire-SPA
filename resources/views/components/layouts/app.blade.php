...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/logokotabogor.gif') }}" type="image/png">
    {{-- <link rel="manifest" href="{{ asset('assets/images/favicons/manifest.json') }}">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content={{ asset("assets/images/logokotabogor.png") }}>
