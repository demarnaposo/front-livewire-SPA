<div>
    <section class="home-section home-parallax home-fade home-full-height bg-dark-30" id="home" data-background="assets/images/view_kotabogor.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-30 titan-title-size-1">Selamat Datang Bogorian!</div>
            <div class="font-alt mb-40 titan-title-size-4">We are Bogor</div><a class="section-scroll btn btn-border-w btn-round" href="#about">Learn More</a>
          </div>
        </div>
      </section>
      <div class="main">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <div class="module-subtitle font-serif large-text">Program Wali Kota dan Wakil Wali Kota Tahun 2019 - 2024 merupakan janji-janji kampanye Wali Kota dan Wakil Wali Kota yang strategis dan prioritas untuk dilaksanakan pada tahun 2019 - 2024. Program unggulan ini salah satu arah kebijakan terhadap pencapaian visi dan misi pembangunan Kota Bogor tahun 2019 - 2024. Program unggulan 2019 - 2024. </div>
              </div>
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <h2 class="module-title font-alt">“Mewujudkan Kota Bogor sebagai Kota Ramah Keluarga”</h2>
              <div class="module-subtitle font-serif large-text">Program Wali Kota dan Wakil Wali Kota Tahun 2019 - 2024 merupakan janji-janji kampanye Wali Kota dan Wakil Wali Kota yang strategis dan prioritas untuk dilaksanakan pada tahun 2019 - 2024. Program unggulan ini salah satu arah kebijakan terhadap pencapaian visi dan misi pembangunan Kota Bogor tahun 2019 - 2024. Program unggulan 2019 - 2024 meliputi : </div>
            </div>
          </div> -->
        ...
        <section class="module bg-dark-60 parallax-bg" data-background="assets/images/finance/finance_funfact_bg.jpg" style="background-position: 50% 15%;">
          <div class="container">
            <div class="row multi-columns-row">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  ...
                  <h3 class="alt-features-title font-alt">Kecamatan Bogor Utara</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-target"></span></div>
                  <h3 class="alt-features-title font-alt">Kecamatan Bogor Barat</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-tools"></span></div>
                  <h3 class="alt-features-title font-alt">Kecamatan Bogor Selatan</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
              </div>
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126829.29007905214!2d106.791892!3d-6.595193500000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5b7ad0f824b%3A0x4c71fd1b0b8ae76d!2sKota%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1733975067487!5m2!1sid!2sid" width="517" height="704" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
              </div>
              <!-- <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  ...
                  <h3 class="alt-features-title font-alt">Kecamatan Bogor Timur</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                  <h3 class="alt-features-title font-alt">Kecamatan Bogor Tengah</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-linegraph"></span></div>
                  <h3 class="alt-features-title font-alt">Kecamatan Tanah Sareal</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="module" id="news">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Berita Kota Bogor</h2>
                <div class="module-subtitle font-serif">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</div>
              </div>
            </div>
            <div class="row multi-columns-row post-columns">
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="assets/images/riksa-budaya.jpg" alt="Blog-post Thumbnail"/></a></div>
                  <div class="post-header font-alt">
                    <h2 class="post-title"><a href="#">Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa Barat</a></h2>
                    <div class="post-meta">By&nbsp;<a href="#">Admin Diskominfo</a>&nbsp;| 10 Desember | 3 Komentar
                    </div>
                  </div>
                  <div class="post-entry">
                    <p>Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa Barat, Dinas Pariwisata dan Kebudayaan (Disparbud) Jawa Barat bersama Disparbud Kota Bogor akan menggelar acara Riksa Budaya Jawa Barat pada 11 Desember 2024 di Alun-alun.....</p>
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="assets/images/riksa-budaya.jpg" alt="Blog-post Thumbnail" class="img-rounded"/></a></div>
                  <div class="post-header font-alt">
                    <h2 class="post-title"><a href="#">Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa Barat</a></h2>
                    <div class="post-meta">By&nbsp;<a href="#">Admin Diskominfo</a>&nbsp;| 10 Desember | 3 Komentar
                    </div>
