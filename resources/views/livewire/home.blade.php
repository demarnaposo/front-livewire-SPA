       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-sm-8">
                   ...
                   <div class="module-subtitle font-serif large-text">Program Wali Kota dan Wakil Wali Kota Tahun
                       2019 - 2024 merupakan janji-janji kampanye Wali Kota dan Wakil Wali Kota yang strategis dan
                       prioritas untuk dilaksanakan pada tahun 2019 - 2024. Program unggulan ini salah satu arah
           ...
           {{-- <div class="row multi-columns-row">
               <div class="col-md-3 col-sm-6 col-xs-12">
                   <div class="features-item">
                       ...
                       <p>Careful attention to detail and clean, well structured code ensures a smooth user
                           experience for all your visitors.</p>
                   </div>
               </div>
               <div class="col-md-3 col-sm-6 col-xs-12">
                   <div class="features-item">
           ...
           <div class="row">
               <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="alt-features-item">
                       ...
                       <h3 class="alt-features-title font-alt">Kecamatan Bogor Utara</h3>A wonderful serenity has
                       taken possession of my entire soul like these sweet mornings.
                   </div>
                   <div class="alt-features-item">
                       <div class="alt-features-icon"><span class="icon-target"></span></div>
                       <h3 class="alt-features-title font-alt">Kecamatan Bogor Barat</h3>A wonderful serenity has
                       taken possession of my entire soul like these sweet mornings.
                   </div>
                   <div class="alt-features-item">
                       <div class="alt-features-icon"><span class="icon-tools"></span></div>
                       <h3 class="alt-features-title font-alt">Kecamatan Bogor Selatan</h3>A wonderful serenity
               ...
               <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                   <div class="alt-services-image align-center"><iframe
                           ...
                           width="517" height="704" style="border:0;" allowfullscreen="" loading="lazy"
           ...
           <div class="alt-services-image align-center"><img src="assets/images/promo.png" alt="Feature Image"></div>
               ...
               <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="alt-features-item">
                       ...
                       <h3 class="alt-features-title font-alt">Kecamatan Bogor Timur</h3>A wonderful serenity has
                       taken possession of my entire soul like these sweet mornings.
                   </div>
                   <div class="alt-features-item">
                       <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                       <h3 class="alt-features-title font-alt">Kecamatan Bogor Tengah</h3>A wonderful serenity has
                       taken possession of my entire soul like these sweet mornings.
                   </div>
                   <div class="alt-features-item">
                       <div class="alt-features-icon"><span class="icon-linegraph"></span></div>
                       <h3 class="alt-features-title font-alt">Kecamatan Tanah Sareal</h3>A wonderful serenity has
                       taken possession of my entire soul like these sweet mornings.
                   </div>
               </div>
           </div>
           ...
           <div class="row multi-columns-row post-columns">
               <div class="col-sm-6 col-md-4 col-lg-4">
                   <div class="post mb-20">
                       <div class="post-thumbnail"><a href="#"><img src="assets/images/riksa-budaya.jpg"
                                   alt="Blog-post Thumbnail" /></a></div>
                       <div class="post-header font-alt">
                           <h2 class="post-title"><a href="#">Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa
                                   Barat</a></h2>
                           <div class="post-meta">By&nbsp;<a href="#">Admin Diskominfo</a>&nbsp;| 10
                               Desember | 3 Komentar
                           </div>
                       </div>
                       <div class="post-entry">
                           <p>Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa Barat, Dinas Pariwisata dan Kebudayaan
                               (Disparbud) Jawa Barat bersama Disparbud Kota Bogor akan menggelar acara Riksa
                               Budaya Jawa Barat pada 11 Desember 2024 di Alun-alun.....</p>
                       </div>
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                   <div class="post mb-20">
                       <div class="post-thumbnail"><a href="#"><img src="assets/images/riksa-budaya.jpg"
                                   alt="Blog-post Thumbnail" class="img-rounded" /></a></div>
                       <div class="post-header font-alt">
                           <h2 class="post-title"><a href="#">Kota Bogor Jadi Tuan Rumah Riksa Budaya Jawa
                                   Barat</a></h2>
                           <div class="post-meta">By&nbsp;<a href="#">Admin Diskominfo</a>&nbsp;| 10
