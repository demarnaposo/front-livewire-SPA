    ...
    <div class="container">
        <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span
                ...
                href="/" wire:navigate><img src="assets/images/logokotabogor.png" alt="logokotabogor" class="img-rounded"
                    width="50px"></a>
        </div>
        <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                {{-- <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Beranda</a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('single-page', ['page' => 'visi-misi']) }}" wire:navigate>Visi Misi</a></li>
                        <li><a href="{{ route('single-page', ['page' => 'tugas-fungsi']) }}" wire:navigate>Tugas dan Fungsi</a></li>
                        <li><a href="index_agency.html"></a></li>
                        <li><a href="index_portfolio.html">Muspimwil dan Muspida</a></li>
                        <li><a href="index_restaurant.html">Struktur Pemerintahan</a></li>
                        <li><a href="index_finance.html">Dokumen Perencanaan</a></li>
                        <li><a href="index_landing.html">Perangkat Daerah</a></li>
                        <li><a href="index_photography.html">Badan Usaha Milik Daerah</a></li>
                        <li><a href="index_shop.html">Transparasi Publik</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Sekilas Kota
                        Bogor</a>
                    <ul class="dropdown-menu">
                        <li class="dropdown"><a class="dropdown-toggle" href="" data-toggle="dropdown">Sejarah
                                Kota Bogor</a>
                            <ul class="dropdown-menu">
                                <li><a href="index_mp_fullscreen_static.html">Pariwisata Kota Bogor</a></li>
                                <li><a href="index_mp_classic_static.html">Classic</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Pariwisata
                                Kota Bogor</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Lambang
                                Kota Bogor</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Letak
                                Geografis</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Gradient
                                Overlay Header</a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Informasi Kota</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Portfolio</a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Hover
                                Style</a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Features</a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="tabs_and_accordions.html"><i class="fa fa-tasks"></i> Tabs &amp; Accordions</a>
                        </li>
